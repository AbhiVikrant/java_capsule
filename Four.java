/*
 * WAP to enter a number and find the next palindrome number 
 */
...
public class Four {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter a number to find the next smallest palindrome number ");
             ...
             generateNextPalindrome(newGuess, newGuess.length);
	}
